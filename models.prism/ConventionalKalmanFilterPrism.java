...
public class ConventionalKalmanFilterPrism extends DefaultModelGenerator {
  ...
  public State getInitialState() throws PrismException {
    ...
    state.varValues[4] =
        Computations.getIntegralPartAsInt(pm.getInitialErrorCovariance().getEntry(0, 0), decPlaces);
    state.varValues[5] = Computations
        .getFractionalPartAsInt(pm.getInitialErrorCovariance().getEntry(0, 0), decPlaces); // P_11
    state.varValues[6] =
        Computations.getIntegralPartAsInt(pm.getInitialErrorCovariance().getEntry(0, 1), decPlaces);
    state.varValues[7] = Computations
        .getFractionalPartAsInt(pm.getInitialErrorCovariance().getEntry(0, 1), decPlaces); // P_12
    state.varValues[8] =
        Computations.getIntegralPartAsInt(pm.getInitialErrorCovariance().getEntry(1, 0), decPlaces);
    state.varValues[9] = Computations
        .getFractionalPartAsInt(pm.getInitialErrorCovariance().getEntry(1, 0), decPlaces); // P_21
    state.varValues[10] =
        Computations.getIntegralPartAsInt(pm.getInitialErrorCovariance().getEntry(1, 1), decPlaces);
  ...
  public State computeTransitionTarget(int i, int offset) throws PrismException {
    ...
    int s_int_11 =
        Computations.getIntegralPartAsInt(kf.getInnovationCovariance().getEntry(0, 0), decPlaces);
    int s_frac_11 =
        Computations.getFractionalPartAsInt(kf.getInnovationCovariance().getEntry(0, 0), decPlaces);
    ...
    int P_post_11_int =
        Computations.getIntegralPartAsInt(kf.getErrorCovarianceMatrix().getEntry(0, 0), decPlaces);
    int P_post_11_frac = Computations
        .getFractionalPartAsInt(kf.getErrorCovarianceMatrix().getEntry(0, 0), decPlaces);
    int P_post_12_int =
        Computations.getIntegralPartAsInt(kf.getErrorCovarianceMatrix().getEntry(0, 1), decPlaces);
    int P_post_12_frac = Computations
        .getFractionalPartAsInt(kf.getErrorCovarianceMatrix().getEntry(0, 1), decPlaces);
    int P_post_21_int =
        Computations.getIntegralPartAsInt(kf.getErrorCovarianceMatrix().getEntry(1, 0), decPlaces);
    int P_post_21_frac = Computations
        .getFractionalPartAsInt(kf.getErrorCovarianceMatrix().getEntry(1, 0), decPlaces);
    int P_post_22_int =
        Computations.getIntegralPartAsInt(kf.getErrorCovarianceMatrix().getEntry(1, 1), decPlaces);
      ...
      if (s == 0 && t < max_time) {
        ...
        target.setValue(21,
            Computations.getFractionalPartAsInt(Computations
                .calcTransProbAndExpectedVal(sim_proc_noise, gLevel, decPlaces)[2 * offset + 1],
                decPlaces));
        target.setValue(22, Computations.getIntegralPartAsInt(
            Computations.calcTransProbAndExpectedVal(meas_noise, gLevel, decPlaces)[2 * offset + 1],
            decPlaces));
        target.setValue(23, Computations.getFractionalPartAsInt(
            Computations.calcTransProbAndExpectedVal(meas_noise, gLevel, decPlaces)[2 * offset + 1],
            decPlaces));
