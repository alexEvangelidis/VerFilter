...
public class SchmidtCarlsonFilterPrismPropC extends DefaultModelGenerator {
  ...
  public SchmidtCarlsonFilterPrismPropC(int gLevel, int decPlaces, double sigma2, double Dt,
      RealMatrix G, NormalDistribution sim_proc_noise, NormalDistribution measNoise,
      DefaultProcessModel pm, MeasurementModel mm, int max_time) throws PrismException,
      IllegalArgumentException, IllegalStateException, InterruptedException, ExecutionException {
    this.pm = pm;
    this.mm = mm;
    this.G = G;
    this.gLevel = gLevel;
  ...
  public State computeTransitionTarget(int i, int offset) throws PrismException {
    ...
    RealVector wEntries = new ArrayRealVector(new double[] {
        ...
        (int) explore.varValues[20]
            + ((int) explore.varValues[21] / (Math.pow(10, decPlaces)) * Dt)});
  ...
  public boolean isLabelTrue(int i) throws PrismException {
    RealMatrix cPostPrism = new Array2DRowRealMatrix(new double[][] {{
